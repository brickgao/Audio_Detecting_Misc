function output_huff = requantizer(input_huff, scalefac, scale_distro, block_type, blocksplit_flag, global_gain, subblock_gain, preflag, scalefac_scale, switch_point)
